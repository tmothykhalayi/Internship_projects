This repository contains several web applications and tools that demonstrate various programming and web development skills. Below are brief descriptions of each project:
